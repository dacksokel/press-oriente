...
echo detrasdelaweb_parte1($conectar);
}
if($parte2==2){
echo detrasdelaweb_parte2($conectar);	
}
/*********************************************************************************************************
 * ************************************************************************************************************
 * ******************************************************************************************************/
function detrasdelaweb_parte1($conectar){
$arregloPrueba2=array();
$auxNoti="";
for($i=1;$i<=15;$i++){
	$auxNoti=$auxNoti.buscar_noticias_detrasdelaweb($conectar, $i);
...
function buscar_noticias_detrasdelaweb($conectar,$i){
	$res_aqui="";	
	$selector=mysql_query('select titulo,contenido,autor,video,imagen,fecha,hora,posicion,id,publicar,urllink from noticiasdetrasdelaweb', $conectar)or die("error al conectarse a la tabla de detrasdelaweb ");
