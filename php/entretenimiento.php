...
echo entretenimiento_parte1($conectar);
}
if($parte2==2){
echo entretenimiento_parte2($conectar);	
}
/*********************************************************************************************************
 * ************************************************************************************************************
 * ******************************************************************************************************/
function entretenimiento_parte1($conectar){
$arregloPrueba2=array();
$auxNoti="";
for($i=1;$i<=8;$i++){
	$auxNoti=$auxNoti.buscar_noticias_entretenimiento($conectar, $i);
...
function buscar_noticias_entretenimiento($conectar,$i){
	$res_aqui="";	
	$selector=mysql_query('select titulo,contenido,autor,video,imagen,fecha,hora,posicion,id,publicar,urllink from noticiasentretenimiento', $conectar)or die("error al conectarse a la tabla de entretenimiento ");
