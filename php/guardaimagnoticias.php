...
header('Access-Control-Allow-Origin: http://panelcontrol.press-oriente.com');//header('Access-Control-Allow-Origin: http://localhost/pressorientepanelv3');
...
if($tipoarchivo=="image/jpeg"){
	...
	if(move_uploaded_file($archivoTemp,"../img/noticias/$filenombre")){
	...
	echo "el archivo no es valido al no ser una imagen";
}
